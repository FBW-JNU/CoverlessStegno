...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--max_dataset_size', type=int, default=16135, help='')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='uspaderes', help='selects model to use for netG (pix2pixhd | spade | unet | uspaderes)')
        ...
        parser.add_argument('--CBN_intype', type=str, default='warp', help='type of CBN input for framework, warp/mask/warp_mask')
        ...
        parser.add_argument('--warp_cycle_w', type=float, default=0.05, help='push warp cycle to ref')
        ...
        parser.add_argument('--warp_patch', type=bool,default=False, help='use corr matrix to warp 4*4 patch') 
