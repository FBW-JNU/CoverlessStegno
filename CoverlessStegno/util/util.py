...
# vis = visdom.Visdom(server='http://localhost', port=8097,env='liguofeng') # visdom设置环境
...
# vis.line([0.], [0.], win='no_vgg_feat', opts=dict(title='no_vgg_feat'))
# vis.line([0.], [0.], win='GAN', opts=dict(title='GAN'))
# vis.line([0.], [0.], win='GAN_Feat', opts=dict(title='GAN_Feat'))
# vis.line([0.], [0.], win='fm', opts=dict(title='fm'))
# vis.line([0.], [0.], win='perc', opts=dict(title='perc'))
# vis.line([0.], [0.], win='contextual', opts=dict(title='contextual'))
# vis.line([0.], [0.], win='reveal_loss', opts=dict(title='reveal_loss'))
# vis.line([0.], [0.], win='D_Fake', opts=dict(title='D_Fake'))
# vis.line([0.], [0.], win='D_real', opts=dict(title='D_real'))

def print_current_errors(opt, epoch, i, errors, t, total_iters):
    ...
    for k, v in errors.items():
        ...
        v = v.mean().float()
        message += '%s: %.3f ' % (k, v)
        # vis.line([float(v)], [total_iters], win=(k),
        #         update='append') # visdom打印,k是某一个loss名称,v是对应loss
